...
namespace BenchMarks
{
    ...
    public class TLSTest
    {
        ...
        SecureChannel _clientContext;
        SecureChannel _serverContext;
        byte[] _MessageToPass;
        ...
        public void Setup()
        {
            ...
            //var serverGlobalContext = new SspiGlobal(fact, "timslaptop",true,  _serverCertificate,ProtocolIds.Http11);

            //var clientGlobalContext = new SspiGlobal(fact, "timslaptop",true, null, ProtocolIds.Http11);

            //_clientContext = clientGlobalContext.CreateSecureChannel()
