...
namespace Channels.Networking.Windows.Tls.Internal
{
    public unsafe static class InteropSspi
    {
        ...
        [DllImport(Dll, ExactSpelling = true, SetLastError = true, CharSet = CharSet.Unicode)]
        internal static extern int QueryContextAttributesW(ref SSPIHandle phContext, [In] InteropEnums.ContextAttribute contextFlag, [Out] out SecPkgContext_ApplicationProtocol protocolInfo);
